export const feed=require("../assets/icons/feed.png");
export const checklist=require("../assets/icons/checklist.png");
...
export const human=require("../assets/icons/human.png");

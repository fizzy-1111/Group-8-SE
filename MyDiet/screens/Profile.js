...
const onPressProfileDetail = ({navigation})=>{
   ...
   return(
       <View style={styles.container}>
           ...
           <SafeAreaView  style={styles.mid}>
            ...
            <Text style={{fontSize:24,marginTop:5,fontWeight: 'bold'}} >{getUsername()} </Text>
           </SafeAreaView>
           </SafeAreaView>
           <SafeAreaView  style={styles.bot}> 
             <SafeAreaView style={styles.setting}>
                ...
                <Container onPress={()=> {onPressProfileDetail({navigation})}}> 
                     <Image source={icons.expandright} style={{width:33,height:35}}/>
                </Container>
             </SafeAreaView>
             <SafeAreaView style={styles.setting}>
